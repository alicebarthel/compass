...
This test case is described in detail in the User guide (see :ref:`mitgcm_baroclinic_gyre`). Here,
...
The class :py:class:`compass.ocean.tests.mitgcm_baroclinic_gyre.initial_state.InitialState`
...
The class :py:class:`compass.ocean.tests.mitgcm_baroclinic_gyre.forward.Forward`
...
``ocean/mitgcm_baroclinic_gyre/80km/long`` performs a longer (3 year) integration
